...
export default function CTA() {
  return (
    <section className="px-6 lg:px-12 pb-40 mt-20" id="contact">
      <motion.div
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        className="max-w-7xl mx-auto rounded-[3rem] overflow-hidden bg-primary shadow-2xl p-12 lg:p-32 relative group"
      >
        ...
        <div className="max-w-4xl space-y-12 relative z-10">
          <div className="space-y-6">
            <div className="flex items-center gap-3 text-accent animate-pulse font-bold uppercase tracking-[0.4em] text-[10px]">
              <Sparkles size={14} />
          ...
          <p className="text-secondary/70 text-xl max-w-3xl font-medium leading-relaxed">
          ...
          <div className="flex flex-col md:flex-row flex-wrap gap-8 items-start md:items-center pt-8">
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-accent text-secondary px-10 py-5 rounded-full font-black uppercase tracking-widest text-sm flex items-center gap-4 hover:shadow-[0_0_40px_rgba(97,64,81,0.5)] border border-accent/50 transition-shadow"
            >
            ...
            <div className="flex items-center gap-6 text-secondary/80 group-hover:text-secondary transition-colors cursor-pointer ml-2">
              <div className="w-16 h-16 rounded-full border border-secondary/20 flex items-center justify-center hover:bg-accent hover:border-accent transition-all">
              ...
              <div className="space-y-1">
                ...
                <a href="tel:+971567692421" className="text-2xl font-black tracking-tighter hover:text-accent transition-colors block">
                  +971 56 769 2421
                </a>
              </div>
            </div>
