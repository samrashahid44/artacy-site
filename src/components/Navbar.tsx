  ...
  return (
    <nav className="fixed top-0 w-full z-50 glass-nav border-b border-primary/5 shadow-sm">
      <div className="flex justify-between items-center w-full px-6 lg:px-12 py-3 max-w-[1600px] mx-auto">
        ...
        >
          <a href="#">
            <img src="/logo.png" alt="Artacy Logo" className="h-[4.5rem] w-auto object-contain " />
          </a>
        </motion.div>
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="bg-primary text-secondary px-6 py-2.5 rounded-full text-[10px] font-black uppercase tracking-widest shadow-xl hover:shadow-accent/20 transition-all border border-primary inline-flex items-center"
        >
          Book a Consultation
        </motion.a>
      </div>
